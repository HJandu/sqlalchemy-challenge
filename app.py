...
#################################################
app = Flask(__name__)
#,static_url_path='/Images/surfs-up.png'
...
def welcome():
    ...
    return (
        f"<h1>Welcome to the Climate App API Step 2!</h1>"
        f"This is the Flask API based on the queries developed .<br/><br/><br/>"
        f" <img width='600' src='https://media.cnn.com/api/v1/images/stellar/prod/221104155610-great-white-shark-surfer-photobomb-trnd.jpg?c=16x9&q=h_540,w_960,c_fill'/ >"
        ...
        f"<h2>Click on the links below, to access the pages:</h2>"
        ...
        f"Calculates the minimum, average, and maximum temperature for all dates greater than and equal to the start date</a></li><br/><br/>"
        f"<li><a href=http://127.0.0.1:5000/api/v1.0/2016-08-23/2017-08-23>"
        f"Calculate the minimum, average, and maximum temperature for dates between the start and end date</a></li></ol><br/>"
)
